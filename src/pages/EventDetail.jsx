...
import { events } from "./Events";  // Import from events page
...
export default function EventDetail() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-100 pb-20">
      ...
      {/* Banner */}
      <div className="relative h-40 w-full rounded-b-3xl shadow-lg bg-gradient-to-r from-blue-600 to-purple-600 flex items-end p-10">
