      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            The Student Wing is a student-led initiative in our college that
            works for the betterment of students. We organize events, provide
            mentorship, and act as a bridge between students, faculty, and alumni
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-700">
              To empower students through innovative programs, mentorship
              opportunities, and a supportive community that fosters both
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <p className="text-gray-700">
              To create a dynamic learning environment where every student can
              discover their potential, develop essential skills, and become
              future-ready leaders in their chosen fields.
            </p>
          </div>
        </div>
